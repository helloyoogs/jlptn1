                ...
                question: [
                    ...
                    },
                    {
                        ...
                        options: ['Aは強い心を育てる教育が大切だと述べ、Ｂは困難な時でも気持ちを切り替えることができる力が大切だと述べている。',
                            'Aは大人が子供を認めることが大切だと述べ、Bは周囲の人に認められる経験が大切だと述べている。',
            ...
            },
            {
                ...
                question: [
                    ...
                    },
                    {
                        ...
                        qReading: null,
                        options: ['教師の採用数が一定であり、優秀な男性が他の職業を選ぶため',
                            '教師の採用数が一定であり、男性は経済的動機では志望を変えないため',
                            '優秀な女性が他の職業を選ぶことで、採用枠に余りが出るため',
                            '優秀な男性が他の職業を選ぶことで、経済的動機が生じるため'],
                        correct:3
                    },
                    {
                        number: 67,
