            ...
            },
            {
                ...
                question: [
                    ...
                    },
                    {
                        ...
                        qReading: null,
                        a1: <>① 年寄りには新語やカタカナ語は難しすぎる<br/>
                            ② グローバル化でカタカナ語の重要性が増した</>,
                        a2: <>① 一般的でないカタカナ語は使うべきではない<br/>
                            ② １００年後にも正しい日本語を使っていけるように守るべきだ </>,
                        a3: <>① 若者は外見ばかり気にして言葉遣いがよくない<br/>
                            ② グローバル化で日本語が日本語でなくなる </>,
                        a4: <>
                            ① 使う言葉によって人の価値も決まる<br/>
                            ② 新語もいずれは古い言葉になってしまう
            ...
            },
            {
                ...
                question: [
                    ...
                    },
                    {
                        ...
                        qReading: null,
                        a1: '一定期間を過ぎたら別の会社でも「ジェネリック」として安価に薬品を製' +
                            '造・販売できるため、各社共に開発に多額のコストを負担するようなことは' +
                            'ない。 ',
                        a2: ' 新薬開発にかけるコストより、大手製薬会社は合併や買収を繰り返すことで' +
                            '他社の新薬を自分たちのものにしてきた。',
                        a3: '臨床試験が厳格化している現状では、新薬がなかなか承認されないため、開' +
                            '発費を負担しようとする会社が少なくなってきた。 ',
                        a4: '大手薬品会社でも、商品の種類が少ないところもあるため、商品の特許が切' +
                    ...
                    },
                    {
                        ...
                        qReading: null,
                        a1: '社会保障費の増加が政府にとって負担になるため、ジェネリックのシェアを' +
                            '上げようとしている目標',
                        a2: '患者の症状に合わせた薬ではなく、合剤で対応されるようになれば、結局は' +
                            '副作用を抑えるために薬を飲むことになること',
                        a3: '新薬の開発にはコストと時間がかかるため、経費を抑えようと大手製薬会社' +
                            'が合併や買収を繰り返していること ',
                        a4: 'ジェネリックや既存薬との合剤が大量に製造され、医療現場では混乱を招い' +
                            'ていること ',
                    },
                    {
                        number: 69,
                        ...
                        q: 'この文章で筆者が最も言いたいことは何か。',
                        qReading: null,
                        a1: '企業の経営維持のためにつくった合剤は、特許切れの薬の利益をまかなうた' +
                            'めだけのものなので、もっと新薬開発に力を注ぐべきだ。 ',
                        a2: '合剤は、今までより薬も薬代も少なくて済むので、政府はジェネリックばか' +
                            'りを広めようとしなくてもいい。',
                        a3: '政府のジェネリックのシェアを上げようとする目標のせいで、全国各地の病' +
                            '院で、医師の混乱を招き、大手メーカーの経営を圧迫している。 ',
                        a4: ' 合剤が普及したら、医師は患者それぞれの症状にきめ細かく対応できなくな' +
